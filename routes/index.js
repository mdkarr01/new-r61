...
router.get("/users/:id", function (req, res) {
  User
    .findById(req.params.id, function (err, foundUser) {
      if (err) {
...
// 2018-05-19T18:46:52.915865+00:00 app[web.1]: Posts.findById(req.params.id,
// async function (err, post) { 2018-05-19T18:46:52.915868+00:00 app[web.1]:
// ^^^^^ 2018-05-19T18:46:52.915869+00:00 app[web.1]: SyntaxError: missing )
// after argument list